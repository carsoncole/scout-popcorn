...
class PaymentMethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_method" do
    assert_difference('PaymentMethod.count') do
      post payment_methods_url, params: { payment_method: { is_active: @payment_method.is_active, name: @payment_method.name, unit_id: @payment_method.unit_id } }
    end
  ...
  test "should update payment_method" do
    patch payment_method_url(@payment_method), params: { payment_method: { is_active: @payment_method.is_active, name: @payment_method.name, unit_id: @payment_method.unit_id } }
