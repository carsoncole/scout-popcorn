...
class PrizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index" do
    sign_in(scouts(:one))
    get prize_cart_url(scouts(:one).prize_cart(events(:one)))
  ...
  #     post prizes_url, params: { prize: { amount: @prize.amount, name: @prize.name } }
  #   end
  ...
  #   patch prize_url(@prize), params: { prize: { amount: @prize.amount, name: @prize.name } }
