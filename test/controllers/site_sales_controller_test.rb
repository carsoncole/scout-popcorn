...
class SiteSalesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create site_sale" do
    assert_difference('SiteSale.count') do
      post site_sales_url, params: { site_sale: { event_id: @site_sale.event_id, name: @site_sale.name } }
    end

    assert_redirected_to site_sale_url(SiteSale.last)
  end

  test "should show site_sale" do
    get site_sale_url(@site_sale)
    assert_response :success
  end
  ...
  test "should update site_sale" do
    patch site_sale_url(@site_sale), params: { site_sale: { event_id: @site_sale.event_id, name: @site_sale.name } }
