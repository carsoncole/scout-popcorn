...
class OnlineSalesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create online_sale" do
    ...
    assert_redirected_to online_sale_url(OnlineSale.last)
  end

  test "should show online_sale" do
    get online_sale_url(@online_sale)
    assert_response :success
  end
  ...
  test "should update online_sale" do
    patch online_sale_url(@online_sale), params: { online_sale: { amount: @online_sale.amount, customer_name: @online_sale.customer_name, description: @online_sale.description, event_id: @online_sale.event_id, order_date: @online_sale.order_date, scout_id: @online_sale.scout_id } }
    assert_redirected_to online_sale_url(@online_sale)
  end
  ...
  test "should destroy online_sale" do
    ...
    assert_redirected_to online_sales_url
  end
end
