class PaymentMethodsController < ApplicationController
  ...
  def index
    @payment_methods = @unit.payment_methods.order(:name)
  end
  ...
  def create
    @payment_method = @unit.payment_methods.build(payment_method_params)
  ...
  private
    ...
    def payment_method_params
      params.require(:payment_method).permit(:name, :unit_id, :is_active, :is_cash)
    end
end
